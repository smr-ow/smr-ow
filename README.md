...
- **기술 스택**: Cisco ASA Firewall, Security Context, ACL (Access Control List), Active-Active Failover, Router/Switch
...
- **기술 스택**: Rocky Linux, LVM (Logical Volume Manager), 디스크 쿼터, SSH, DNS, Web/FTP/NFS/Samba/DHCP/Mail Server
...
- **기술 스택**: VMware vSphere, ESXi Host, vCenter Server, Active Directory, vSphere Client
...
- **기술 스택**: AWS VPC, Subnet, Internet Gateway (IGW), NAT Gateway, Amazon EC2, SSH
...
- **기술 스택**: AWS VPC, EC2, Application Load Balancer (ALB), Amazon RDS, Amazon S3, CloudWatch, SNS, CloudFormation
...
- **기술 스택**: Terraform, AWS (Provider), GitHub, Terraform Cloud, VSCode, IaC (Infrastructure as Code)
...
- **기술 스택**: AWS EKS (Elastic Kubernetes Service), Kubernetes, EC2, Bastion Host, Docker (inferred), IAM
